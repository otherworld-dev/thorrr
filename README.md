...
<p align="center">
 <em><b>ThorRR</b> is a fork of the open-source <a href="https://github.com/AngelLM/Thor">Thor</a> robotic arm, redesigned around <b>RepRapFirmware</b> with modified parts, optical endstops, and an updated BOM.</em>
</p>
<p align="center">
...
- Newly designed control application called [Bifrost](https://github.com/otherworld-dev/Bifrost)
...
- [**Bifrost**](https://github.com/otherworld-dev/Bifrost): Control application designed for ThorRR.
...
3. **Get the Hardware**: Take a look at the [Bill of Materials](http://thor.angel-lm.com/documentation/bom/). Note that ThorRR has some BOM differences — see above.
...
5. **Assemble & Setup the Electronics**: The [Wiring & Setup](http://thor.angel-lm.com/documentation/electronics/) guide covers the general approach. ThorRR uses a BigTreeTech Octopus Pro v1.0 instead of the Arduino Mega shield.
6. **Install the Firmware**: ThorRR uses RepRapFirmware. The original Thor firmware docs are [here](http://thor.angel-lm.com/documentation/firmware/) for reference.
7. **Control the Robot**: Use [Bifrost](https://github.com/otherworld-dev/Bifrost) to control the robot.
...
- [thor.angel-lm.com](http://thor.angel-lm.com/) — Official website for the original Thor project
- [FAQ](http://thor.angel-lm.com/faq/)
- [Thor Forums](http://thor.angel-lm.com/forums/)
- [Thor Discord Server](https://discord.com/invite/a5dSVqSUK5)
